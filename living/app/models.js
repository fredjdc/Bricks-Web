 ...
 * @typedef {'pending_approval'|'approved'|'confirmed'|'completed'|'cancelled'|'rejected'|'no_show'} ReservationStatus
 ...
 * @typedef {{building:object, areas:Array<object>, residents:Array<object>, apartments:Array<object>, reservations:Array<LivingReservation>, tasks:Array<object>, incidents:Array<LivingIncident>, messages:Array<object>, paymentLedger:Array<object>, depositLedger:Array<object>, maintenanceBlocks:Array<object>, superAdmin:object, auditLog:Array<object>}} LivingData
 */
...
(function registerLivingModels(global) {
  ...
  global.validateLivingData = function validateLivingData(data) {
    ...
    ["areas", "residents", "apartments", "reservations", "tasks", "incidents", "messages", "paymentLedger", "depositLedger", "maintenanceBlocks", "auditLog"].forEach((key) => assertArray(data, key, errors));
    ...
    const ids = new Set();
    const reservationStatuses = new Set(["pending_approval", "approved", "confirmed", "completed", "cancelled", "rejected", "no_show"]);
