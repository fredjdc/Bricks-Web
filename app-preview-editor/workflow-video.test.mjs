...
assert.match(html, /<script src="script\.js\?v=20260716-1" defer><\/script>/);
...
assert.doesNotMatch(html, /name="(?:building|app_link|preview_challenge)"|data-signup-step="beta"|data-beta-back/);
